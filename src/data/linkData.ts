export const linkData = [
    {
      category: "Icons",
      header: "React Icons",
      text: "React Icons is a library that enables developers to seamlessly integrate a diverse range of icons into their React applications. It supports numerous icon packs, including Font Awesome, Material Design Icons, and others.",
      url: "https://react-icons.github.io/react-icons/",
    },
    {
      category: "Icons",
      header: "Font Awesome",
      text: "Font Awesome is a popular icon library that can be used in various projects to enhance UI with scalable vector icons.",
